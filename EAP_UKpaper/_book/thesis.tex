...
\title{A Cross-sectional Forecasting Model in the UK Stock Returns}
...
\date{July 07,2022}
\division{TUM School of Management}
\advisor{Dr.~Matthias Hanauer}
\institution{Technische Universität München}
\degree{seminar}
%If you have two advisors for some reason, you can use the following
% Uncommented out by CII
\altadvisor{Prof.~Dr.~Christoph Kaserer}
% End of CII addition

%%% Remember to use the correct department!
\department{Department of Financial Management and Capital Markets}
...
\emph{R Markdown} uses \emph{pandoc} (\url{https://pandoc.org/}) to build its bibliographies. One nice caveat of this is that you won't have to do a second compile to load in references as standard LaTeX requires. To cite references in your thesis (after creating your bibliography database), place the reference name inside square brackets and precede it by the ``at'' symbol. For example, here's a reference to a book about worrying: (Roland Füss, n.d.). This \texttt{Molina1994} entry appears in a file called \texttt{thesis.bib} in the \texttt{bib} folder. This bibliography database file was created by a program called BibTeX. You can call this file something else if you like (look at the YAML header in the main .Rmd file) and, by default, is to placed in the \texttt{bib} folder.

For more information about BibTeX and bibliographies, see our CUS site (\url{https://web.reed.edu/cis/help/latex/index.html})\footnote{Eoghan Nichol (n.d.)}. There are three pages on this topic: \emph{bibtex} (which talks about using BibTeX, at \url{https://web.reed.edu/cis/help/latex/bibtex.html}), \emph{bibtexstyles} (about how to find and use the bibliography style that best suits your needs, at \url{https://web.reed.edu/cis/help/latex/bibtexstyles.html}) and \emph{bibman} (which covers how to make and maintain a bibliography by hand, without BibTeX, at \url{https://web.reed.edu/cis/help/latex/bibman.html}). The last page will not be useful unless you have only a few sources.
...
\item
  You can add a Reed Thesis citation\footnote{Roland Füss (n.d.)} option. The best way to do this is to use the phdthesis type of citation, and use the optional ``type'' field to enter ``Reed thesis'' or ``Undergraduate thesis.''
\end{itemize}
...
Eoghan Nichol, M. D. (n.d.). Profitability and investment factors for UK asset pricing models. Journal Article.

\leavevmode\vadjust pre{\hypertarget{ref-RN16}{}}%
Fama, E. F. (1993). Common risk factors in the returns on stocks and bonds. Journal Article.

\leavevmode\vadjust pre{\hypertarget{ref-RN17}{}}%
Fama, E. F., \& French, K. R. (2015). A five-factor asset pricing model. \emph{Journal of Financial Economics}, \emph{116}(1), 1--22. Journal Article. http://doi.org/\href{https://doi.org/10.1016/j.jfineco.2014.10.010}{10.1016/j.jfineco.2014.10.010}

\leavevmode\vadjust pre{\hypertarget{ref-RN51}{}}%
Foran, J., \& O'Sullivan, N. (2014). Liquidity risk and the performance of UK mutual funds. \emph{International Review of Financial Analysis}, \emph{35}, 178--189. Journal Article. http://doi.org/\url{https://doi.org/10.1016/j.irfa.2014.09.001}

\leavevmode\vadjust pre{\hypertarget{ref-RN60}{}}%
Foye, J. (2018). Testing alternative versions of the fama--french five-factor model in the UK. \emph{Risk Management}, \emph{20}(2), 167--183. Journal Article. http://doi.org/\href{https://doi.org/10.1057/s41283-018-0034-3}{10.1057/s41283-018-0034-3}

\leavevmode\vadjust pre{\hypertarget{ref-RN58}{}}%
Roland Füss, M. G., Christian Koeppel. (n.d.). Sentiment risk premia in the cross-section of global equity. Journal Article.
